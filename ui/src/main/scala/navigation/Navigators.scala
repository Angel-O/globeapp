...
object Navigators {
  def navigateToLogin()(implicit bh: BrowserHistory) = bh.navigateTo(LoginPageURI)  
  def navigateToRegister()(implicit bh: BrowserHistory) = bh.navigateTo(RegisterPageURI)
